...
describe('parseSpans', () => {
  ...
  it('can handle three paragraphs with one paragraph on input as plain string', () => {
    const text =
  ...
  it('can handle three paragraphs with one paragraph on input as html', () => {
    const text =
      '<p><span style="color:cmyk(41,69,163,0,255);font-size:33pt;ot:calt,0;ot:liga,1;ot:locl,0;" >MR. AND MRS. JOHN PAUL FRAZIER</span></p><p><span style="ot:calt,0;ot:liga,1;ot:locl,0;" >request the honor of your presence at</span></p><p><span style="ot:calt,0;ot:liga,1;ot:locl,0;" >THE WEDDING OF THEIR DAUGHTER</span></p>';
    const schema = parseSpans(text);
    expect(schema.paragraphs.length).to.equal(3);
  ...
  it('can handle three paragraphs with two paragraphs on input as plain string', () => {
    const text =
      '<p><span style="color:cmyk(41,69,163,0,255);font-size:33pt;ot:calt,0;ot:liga,1;ot:locl,0;" >MR. AND MRS. JOHN PAUL FRAZIER</span></p><p><span style="ot:calt,0;ot:liga,1;ot:locl,0;" >request the honor of your presence at</span></p><p><span style="ot:calt,0;ot:liga,1;ot:locl,0;" >THE WEDDING OF THEIR DAUGHTER</span></p>';
    const schema = parseSpans(text);
    expect(schema.paragraphs.length).to.equal(3);
  ...
  it('can handle three paragraphs with two paragraphs on input as html', () => {
    const text =
      '<p><span style="color:cmyk(41,69,163,0,255);font-size:33pt;ot:calt,0;ot:liga,1;ot:locl,0;" >MR. AND MRS. JOHN PAUL FRAZIER</span></p><p><span style="ot:calt,0;ot:liga,1;ot:locl,0;" >request the honor of your presence at</span></p><p><span style="ot:calt,0;ot:liga,1;ot:locl,0;" >THE WEDDING OF THEIR DAUGHTER</span></p>';
    const schema = parseSpans(text);
    expect(schema.paragraphs.length).to.equal(3);
  ...
  it('can handle three paragraphs with three paragraphs on input as plain string', () => {
    const text =
      '<p><span style="color:cmyk(41,69,163,0,255);font-size:33pt;ot:calt,0;ot:liga,1;ot:locl,0;" >MR. AND MRS. JOHN PAUL FRAZIER</span></p><p><span style="ot:calt,0;ot:liga,1;ot:locl,0;" >request the honor of your presence at</span></p><p><span style="ot:calt,0;ot:liga,1;ot:locl,0;" >THE WEDDING OF THEIR DAUGHTER</span></p>';
    const schema = parseSpans(text);
    expect(schema.paragraphs.length).to.equal(3);
  ...
  it('can handle three paragraphs with three paragraphs on input as html', () => {
    const text =
      '<p><span style="color:cmyk(41,69,163,0,255);font-size:33pt;ot:calt,0;ot:liga,1;ot:locl,0;" >MR. AND MRS. JOHN PAUL FRAZIER</span></p><p><span style="ot:calt,0;ot:liga,1;ot:locl,0;" >request the honor of your presence at</span></p><p><span style="ot:calt,0;ot:liga,1;ot:locl,0;" >THE WEDDING OF THEIR DAUGHTER</span></p>';
    const schema = parseSpans(text);
    expect(schema.paragraphs.length).to.equal(3);
  ...
  it('can handle three paragraphs with four paragraphs on input as plain string with &', () => {
    const text =
      '<p><span style="color:cmyk(41,69,163,0,255);font-size:33pt;ot:calt,0;ot:liga,1;ot:locl,0;" >MR. AND MRS. JOHN PAUL FRAZIER</span></p><p><span style="ot:calt,0;ot:liga,1;ot:locl,0;" >request the honor of your presence at</span></p><p><span style="ot:calt,0;ot:liga,1;ot:locl,0;" >THE WEDDING OF THEIR DAUGHTER</span></p>';
    const schema = parseSpans(text);
    expect(schema.paragraphs.length).to.equal(3);
  ...
  it('can handle three paragraphs with four paragraphs on input as html with &', () => {
    const text =
      '<p><span style="color:cmyk(41,69,163,0,255);font-size:33pt;ot:calt,0;ot:liga,1;ot:locl,0;" >MR. AND MRS. JOHN PAUL FRAZIER</span></p><p><span style="ot:calt,0;ot:liga,1;ot:locl,0;" >request the honor of your presence at</span></p><p><span style="ot:calt,0;ot:liga,1;ot:locl,0;" >THE WEDDING OF THEIR DAUGHTER</span></p>';
    const schema = parseSpans(text);
    expect(schema.paragraphs.length).to.equal(3);
  ...
  it('parseSpans then toString with &', () => {
    const ps = [
      '<p><span style="ot:locl,0;">MARRIAGE OFFICIANT: REVEREND JOHN DILLAN</span></p>',
      '<p><span style="ot:locl,0;">PRELUDE</span></p>',
      '<p></p>',
